...
browser.find_element_by_id('ember895').send_keys("nivtol@gmail.com")
browser.find_element_by_id('ember896').send_keys("London10")
browser.find_element_by_class_name('btn-theme').click() # click on כניסה BUYME
